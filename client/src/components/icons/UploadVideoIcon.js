 ...
 * @param {string} color
 */
export const UploadVideoIcon = ({ width, color }) => {
  const DEFAULT_WIDTH = '20';
  const DEFAULT_COLOR = theme.colors.text.secondary;

  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width || DEFAULT_WIDTH} height="16" fill="currentColor" className="bi bi-camera-video" viewBox="0 0 16 16"> 
